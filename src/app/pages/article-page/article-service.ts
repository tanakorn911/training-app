...
export class ArticleService {
  private readonly API_URL = 'https://etjktcatdhyzpowtulkz.supabase.co/rest/v1/Reviews';
  private readonly API_KEY = 'sb_publishable_5WPpIPvKIMZqJOXFdPXsKg_OAZI_fUw';
